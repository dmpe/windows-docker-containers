...
```
openssl req -x509 -newkey rsa:4096 -sha256 -days 365 -nodes -keyout win-8irmjn1es50.key -out win-8irmjn1es50.crt -subj "/CN=win-8irmjn1es50" -addext "subjectAltName=DNS:win-8irmjn1es50" -addext "keyUsage=digitalSignature" -addext "extendedKeyUsage=serverAuth"
  
openssl pkcs12 -export -out win-8irmjn1es50.pfx -inkey 'C:\Users\john\Downloads\win-8irmjn1es50.key' -in 'C:\Users\john\Downloads\win-8irmjn1es50.crt'

$credential = Get-Credential -UserName 'Enter password below' -Message 'Enter password below'
Import-PfxCertificate -FilePath win-8irmjn1es50.pfx -CertStoreLocation Cert:\LocalMachine\My -Password $credential.Password
